/**
 * @file Layout principal de la aplicación Compañía dentro de TurtleForge Studio.
 *
 * Sidebar con navegación a las secciones de configuración de empresa:
 * Perfil, Marca & Colores, y Templates PDF.
...
/** Color de la app Compañía */
const APP_COLOR = '#6366F1';

/**
 * Elementos del menú de navegación de la app Compañía.
 */
const navItems = [
...
/**
 * Layout de la aplicación Compañía.
 * @returns {JSX.Element}
 */
      ...
      <aside className={`fixed inset-y-0 left-0 z-40 w-64 bg-[#0d1014] text-tech-white flex flex-col transition-transform duration-300 border-r border-[#1e2125] ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} xl:translate-x-0`}>
        ...
        <div className="p-6 border-b border-[#1e2125]">
          ...
          >
            ...
            <h1 className="text-xl font-bold text-tech-white">Compañía</h1>
          </button>
        </div>
      ...
      <div className="flex-1 flex flex-col xl:ml-64">
        ...
        <header className="xl:hidden bg-[#0d1014] text-tech-white px-4 py-3 flex items-center gap-3 sticky top-0 z-20 border-b border-[#1e2125]">
          ...
          >
            ...
            <h1 className="text-lg font-bold text-tech-white">Compañía</h1>
          </button>
        </header>
