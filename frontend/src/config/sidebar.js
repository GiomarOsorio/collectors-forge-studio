...
export const SIDEBAR_APPS = [
  {
    ...
    items: [
      ...
      { to: '/cost/history',     icon: History,    label: 'Historial' },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/inventory/bobinas',      icon: Disc,           label: 'Bobinas' },
      { to: '/inventory/herramientas', icon: Wrench,         label: 'Herramientas' },
      { to: '/inventory/consumibles',  icon: Beaker,         label: 'Consumibles' },
